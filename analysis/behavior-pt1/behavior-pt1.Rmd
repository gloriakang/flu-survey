...
# by income
p + geom_bar() + aes(PPINCIMP, fill = PPINCIMP) + facet_wrap(~Q7_q) +
  ggtitle("By income") + theme(axis.text.x = element_blank())
p + geom_bar(position = "fill") + aes(PPINCIMP, fill = Q7_q)

# by education
p + geom_bar(position = "fill") + aes(PPEDUCAT, fill = Q7_q) + ggtitle("By education")
p + geom_bar() + aes(PPEDUCAT, fill = PPEDUCAT) + facet_wrap(~Q7_q) +
