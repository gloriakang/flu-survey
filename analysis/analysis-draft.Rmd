...
q15 <- as.data.frame(svytable(
  ~Q15 + Q13 + PPGENDER + ppagect4 + PPETHM + income + PPEDUCAT, des, round = T))
...
## drop where too few observations
#df_sub <- df_sub[!df_sub$Q17=="More than $60" & !df_sub$Q13=="No, never", ]
df_sub <- df_sub[!df_sub$Q17=="More than $60", ]
nrow(df_sub)
