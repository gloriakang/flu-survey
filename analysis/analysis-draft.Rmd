...
gen <- p + aes(PPGENDER) + fil + geom_bar(position = "dodge") + title
age <- p + aes(ppagect4) + fil + geom_bar(position = "dodge")
eth <- p + aes(PPETHM) + fil + geom_bar(position = "dodge") + coord_flip()
inc <- p + aes(income) + fil + geom_bar(position = "dodge") + title
edu <- p + aes(PPEDUCAT) + fil + geom_bar(position = "dodge") + title
wor <- p + aes(work) + fil + geom_bar(position = "dodge")
mar <- p + aes(marital) + fil + geom_bar(position = "dodge")
