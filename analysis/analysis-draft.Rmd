...
```{r}
## Q14. How much do you pay to get an influenza vaccine?
q14 <- as.data.frame(svytable(~Q14 + ppagecat + PPGENDER + PPETHM + income + PPEDUCAT + work + marital, des, round = T))
...
```{r}
## Q20. How effective do you think the influenza vaccine is in protecting people from becoming sick with influenza?
q20 <- as.data.frame(svytable(~Q20 + ppagecat + PPGENDER + PPETHM + income + PPEDUCAT + work + marital, des, round = T))
...
#####
svytable(~Q21 + Q13, des14, round = T)
svyby(~Q21, ~Q13, des14, svymean, na.rm = T)
