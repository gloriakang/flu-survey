...
knitr::opts_chunk$set(echo = T, cache = T, warning = F, message = F, tidy = F, size = "small")
rm(list = ls(all.names = TRUE))
library(rmarkdown); library(tidyr); library(dplyr); library(ggplot2);
...
```{r code-data, eval=FALSE, include=FALSE}
## income
