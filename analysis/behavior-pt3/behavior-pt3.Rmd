...
p2 <- ggplot(q12[q12$Q12_r != "Don_t Know", ], aes(Q12_q, weight = Freq)) + ptext
...
#px <- ggplot(q12[q12$Q12_r == "High Risk", ], aes(weight = Freq)) + ptext
...
svyboxplot(PPAGE~Q12_q, des11, main = "Age boxplot per response")
...
q12.2 <- data.frame(svytable(~Q12_q + Q12_r + PPEDUC + PPEDUCAT + work + PPWORK + marital + PPMARIT, des11, round = T))

# restate plots
p3 <- ggplot(q12.2[q12.2$Q12_r != "Don_t Know", ], aes(Q12_q, weight = Freq)) + ptext
```
