...
```{r}
## Load data variables.
load("~/git/flu-survey/data/cleaning2.RData")  # clean data frame
...
des <- svydesign(ids = ~1, weights = ~weight, data = df[is.na(df$weight) == F, ])  # what is nest?
```

From: https://rpubs.com/corey_sparks/59698
