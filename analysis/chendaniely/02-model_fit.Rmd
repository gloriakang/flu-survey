...
```{r}
ne_demo <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work,
...
```{r}
ns_demo <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work,
...
```{r}
nse_demo <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work,
       design = svy_never_someevery,
       family = quasibinomial(link = "logit"))
print_svy_mod(nse_demo)
```

# Demographic model + Belief

```{r}
ne_demo_belief <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20,
       design = svy_never_every,
       family = quasibinomial(link = "logit"))
...
```{r}
ns_demo_belief <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20,
       design = svy_never_some,
       family = quasibinomial(link = "logit"))
...
```{r}
nse_demo_belief <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20,
       design = svy_never_someevery,
       family = quasibinomial(link = "logit"))
...
# Social influence and herd immunity

```{r}
ne_demo_belief_social <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q15 + Q16 + Q17,
       design = svy_never_every,
       family = quasibinomial(link = "logit"))
...
```{r}
ns_demo_belief_social <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q15 + Q16 + Q17,
       design = svy_never_some,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
```{r}
nse_demo_belief_social <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q15 + Q16 + Q17,
       design = svy_never_someevery,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
AIC(nse_demo, nse_demo_belief, nse_demo_belief_social)
```
...
BIC(nse_demo, nse_demo_belief, nse_demo_belief_social, maximal = nse_demo_belief_social)
```
...
```{r}
ne_demo_belief_social <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q17,
       design = svy_never_every,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
```{r}
ns_demo_belief_social <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q15 + Q17,
       design = svy_never_some,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
```{r}
ne_demo_belief_cost <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q14 + Q19,
       design = svy_never_every,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
```{r}
ns_demo_belief_cost <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q14 + Q19,
       design = svy_never_some,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
```{r}
nse_demo_belief_cost <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q14 + Q19,
       design = svy_never_someevery,
       family = quasibinomial(link = "logit"))
print_svy_mod(ne_demo_belief_social)
```
...
```{r}
ns_demo_belief_barriers <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q18_1 + Q18_2 + Q18_3 + Q18_4 + Q18_5 + Q18_6 + Q18_7 + Q18_8 + Q18_9 + Q18_10,
...
```{r}
ns_demo_belief_barriers <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q18_1 + Q18_2 + Q18_3 + Q18_4 + Q18_5 + Q18_6 + Q18_7 + Q18_8 + Q18_9 + Q18_10 + PPEDUCAT*Q20,
       design = svy_never_some_flipped,
       family = quasibinomial(link = "logit"))
print_svy_mod(ns_demo_belief_barriers)
```
...
```{r}
ns_demo_belief_barriers <- svyglm(formula = Q13 ~ ppagecat + PPEDUCAT + PPETHM + income + marital + work + Q20 + Q18_3 + Q18_5,
       design = svy_never_some_flipped,
       family = quasibinomial(link = "logit"))
print_svy_mod(ns_demo_belief_barriers)
```